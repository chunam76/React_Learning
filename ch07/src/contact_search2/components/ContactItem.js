    ...
    render() {
        return (
            <li className="list-group-item">
                ...
                {/* 삭제 버튼 및 버튼 클릭 이벤트 적용*/}
                <div className="col-xs-1">
                    <div>
                        {/* 부모에게 이벤트와 값을 바로 전달할 수도 있다, deleteContactItem 함수가 필요없어진다.*/}
                        <button className="btn btn-primary"
                            onClick={()=>this.props.deleteContact(this.props.no)}>X</button>
